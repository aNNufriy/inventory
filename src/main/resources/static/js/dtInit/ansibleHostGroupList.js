$(document).ready(function () {
    document.dt = $('table#sample').DataTable({
        'ajax': {
            ...
            'url': '/api/dataTables/ansibleHostGroup',
            'type': 'POST',
            'data': function (d) {
        ...
        "drawCallback": function() {
            $(".dt-edit-btn").click(function(_){
                location.href = "/ansibleHostGroup/"+this.attributes['data-id'].value+"/edit";
            });
            $(".dt-remove-btn").click(function(){
                let url = "/api/ansibleHostGroup/"+this.attributes['data-id'].value;
